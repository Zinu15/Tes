...
// Route::post('/profile', [App\Http\Controllers\ProductController::class, 'store'])->name('store');
Route::get('/profile/create', [App\Http\Controllers\ProductController::class, 'index']);
Route::post('/profile/create', [App\Http\Controllers\ProductController::class, 'store'])->name('store');
